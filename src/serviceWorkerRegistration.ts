...
export function register(config?: Config) {
  if (process.env.NODE_ENV === "production" && "serviceWorker" in navigator) {
    console.log("② 🔵 in serviceWorkerRegistration.ts, we are in prod");
    ...
    window.addEventListener("load", () => {
      ...
      console.log("③ 🔵 window.load event has been called, here is our sw url: ", swUrl);
      ...
      if (isLocalhost) {
        ...
        console.log("④ 🔵 not in localhost, calling registerValidSW");
